...
# sample162: hyper-active 2P (stronger dose of the sample161 idea). Baked in CODE.
_CONFIG_2P_BASE = dataclasses.replace(ProducerLiteConfig(), roi_threshold=0.4, max_waves_per_turn=18)
