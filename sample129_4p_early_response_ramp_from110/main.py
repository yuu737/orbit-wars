...
CONFIG_4P = dataclasses.replace(
    ...
    # sample129: front-load the existing orbit response gate into the turn 25-50
    # early-annihilation window. Reach full defensive strength by turn 45 (was 80)
    # and raise the early ramp floor (was 0.35). No new score terms; only the
    # schedule of the existing hold/defense gate changes. 4P only.
    orbit_response_ramp_end=45,
    orbit_response_ramp_min=0.55,
