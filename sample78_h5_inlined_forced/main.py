...
def _agent_s8() -> ModuleType:
    global _MOD_S8
    if _MOD_S8 is None:
        _MOD_S8 = _load_agent_module("sample8", "_sample76_s8")
    return _MOD_S8
...
def _agent_s7() -> ModuleType:
    global _MOD_S7
    if _MOD_S7 is None:
        _MOD_S7 = _load_agent_module("sample7", "_sample76_s7")
    return _MOD_S7
...
def _agent_4p() -> ModuleType:
    global _MOD_4P
    if _MOD_4P is None:
        _MOD_4P = _load_agent_module("sample69_4p_orbit_lite_response_gate", "_sample76_4p")
    return _MOD_4P
...
def _choose_2p_mode(obs) -> str:
    ...
    if h5_low_mass_prod3_cluster or h5_far_heavy_prod5_anchor or h5_compact_double_prod4:
        return "h5"
