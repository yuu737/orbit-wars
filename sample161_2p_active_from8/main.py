...
# sample161: more-active 2P (shadow-compare vs top players showed they launch 2-4x more).
# Baked in CODE because params.json is ignored under the eval harness. Lower ROI gate +
# more waves/turn => the agent fires more (incl. marginal) launches like the human meta.
