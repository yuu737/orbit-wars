...
CONFIG_2P = dataclasses.replace(
    ...
    true_one_ply_start=10,
    true_one_ply_turn_limit=210,
    true_one_ply_top_k=32,
    true_one_ply_enemy_frac=0.84,
    true_one_ply_enemy_eta_cap=22.0,
    true_one_ply_enemy_reserve_base=4.0,
    true_one_ply_enemy_reserve_prod=1.4,
    true_one_ply_base_weight=0.50,
    true_one_ply_net_scale=0.115,
    true_one_ply_good_bonus=1.10,
    true_one_ply_bad_penalty=1.95,
    true_one_ply_bad_net=-8.0,
    true_one_ply_good_net=14.0,
    true_one_ply_hard_bad_net=-28.0,
