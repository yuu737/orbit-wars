...
def _apply_durable_capture_filter_2p(
    *,
    ...
    # Only enemy-planet captures are filtered. Neutral expansion is left intact:
    # sample153 showed that filtering every capture can erase too many growth
    # lines even when it rescues some churn losses.
