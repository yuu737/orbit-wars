...
def _choose_4p_mode(obs_tensors: dict) -> str:
    ...
    # Targeted lane-anchor rescues from the sample82/85 ablation.
    # These shapes were s7_stable losses in sample69, while nearby
    # high-risk shapes such as 676586300/927652245/1309011149 stayed better
    ...
    if (
        ...
        and chain >= 48.0
        and chain <= 54.0
        and outer_anchor >= 85.0
        and support_density >= 28.0
        and enemy_cluster_risk >= 110.0
    ):
        return "lane_anchor"
    if (
        planets >= 30.0
        ...
        and enemy_cluster_risk >= 65.0
        and enemy_cluster_risk <= 85.0
    ):
        return "lane_anchor"
