...
# SUBMISSION (sample176): 4P = sample173 (Phase-3 expansion drive + light campaign, on the
# orbit_lite split) inherited above; 2P = same as the previously-submitted sample163
# (active: roi_threshold 1.5->0.9, max_waves_per_turn 7->12). Baked in CODE (params.json is
# ignored under the eval harness). 2P engine is orbit_lite_2p (= baseline, unchanged).
