...
# sample139: 2P で守備予約(threat_reserve)を有効化。4P 経路は CONFIG_4P 側で別管理のため不変。
_CONFIG_2P_BASE = dataclasses.replace(ProducerLiteConfig(), enable_threat_reserve_2p=True)
