...
CONFIG_4P = dataclasses.replace(
    ProducerLiteConfig(),
    # sample165: ACTIVE 4P. Real-competition replays (replays_my_4p_163) showed our agent
    # sitting on ~1 planet hoarding ships (opening/expansion PASSIVITY) and getting
    # out-expanded -> died 1st/2nd. Lower ROI gate + more waves so it expands early like
    # the aggressive competition agents (same fix sample161 used for 2P, now for 4P).
    roi_threshold=0.8,
