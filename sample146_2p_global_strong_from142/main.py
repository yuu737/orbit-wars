...
# sample146: stronger 2P global source-selection pass baked into code. This
# keeps the real baseline defaults and only makes the 2A global-select
# behavior aggressive enough to visibly change play.
_CONFIG_2P_BASE = dataclasses.replace(
    ProducerLiteConfig(),
    enable_global_select_2p=True,
    global_select_vuln_weight=1.45,
    global_select_margin=3.0,
    global_select_drop_sweeps=4,
