...
CONFIG_4P_UNIFIED = dataclasses.replace(
    CONFIG_4P,
    horizon=13,
    max_sources_per_lane=6,
    max_offensive_targets=12,
    ...
    enable_lane_anchor_4p=False,
    lane_anchor_turn_limit=105,
    lane_anchor_eta_cap=17.0,
    lane_anchor_max_extra_targets=5,
    lane_anchor_angle_width=1.15,
    lane_anchor_bonus=0.12,
    lane_anchor_prod_bonus=0.018,
    lane_anchor_max_bonus=0.24,
    enable_top_director_4p=False,
    top_director_turn_limit=140,
    top_director_central_brawl_penalty=1.08,
    top_director_nonleader_enemy_penalty=0.52,
    top_director_safe_neutral_bonus=0.48,
    top_director_outer_bonus=0.16,
    top_director_drain_penalty=0.26,
    top_director_reserve_start=18,
    top_director_reserve_limit=112,
    top_director_reserve_roi=-0.38,
    enable_domain_race_4p=False,
    enable_winner_path_4p=False,
    enable_enemy_domain_block_4p=False,
    enable_coord_followup_4p=True,
    coord_start_turn=18,
    coord_turn_limit=165,
    coord_max_extra=2,
