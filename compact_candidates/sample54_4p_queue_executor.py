...
def plan_lite_waves(
    *,
    ...
    if not bool(config.enable_regroup):
        return concat_launch_entries([reserve_entries, lane_entries, wave_entries])
    ...
    return concat_launch_entries([reserve_entries, lane_entries, wave_entries, regroup_entries])
