...
# sample145: softer 2P global source-selection pass baked into code. This
# avoids params.json being skipped when raw Kaggle/evaluate exec has no
# __file__. Baseline-equivalent fields remain at ProducerLiteConfig defaults.
