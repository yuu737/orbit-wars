...
CONFIG_4P = dataclasses.replace(
    ...
    expansion_drive_base_bonus=0.52,
    expansion_drive_lag_bonus=1.08,
    expansion_drive_prod_bonus=0.20,
    expansion_drive_outer_bonus=0.40,
    expansion_drive_cheap_bonus=0.28,
    expansion_drive_enemy_penalty=0.35,
    expansion_drive_center_penalty=0.48,
    expansion_drive_pressure_penalty=0.021,
    expansion_drive_strip_penalty=0.82,
