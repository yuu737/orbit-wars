...
Experimental V6.1 settings:
- Keep the V6.0 unified action-pool structure.
- Gate reserve-using structural moves through a stricter frontier map.
- Favor outer-lane high-production reinforcement only when support and pressure both justify it.
"""
