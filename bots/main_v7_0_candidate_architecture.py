...
V7.0 architecture branch:
- Keep V6.9 behavior as the baseline.
- Split observation parsing, candidate generation, candidate evaluation/selection,
  and post-selection append phases into explicit functions.
- This version is intentionally action-compatible with V6.9 as much as possible;
  the goal is a cleaner base for V7.1 wide candidates and V7.2 forward evaluation.
"""
