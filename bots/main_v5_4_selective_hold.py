...
Experimental V5.4 settings:
- Keep the V5.1 guarded planner as the base.
- Upgrade projected defense sizing for loss-turn planets.
- Add only a light neutral-expansion guard to reduce collapse without freezing the opening.
"""
