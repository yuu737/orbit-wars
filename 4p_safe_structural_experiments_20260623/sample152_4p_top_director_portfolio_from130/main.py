...
CONFIG_4P = dataclasses.replace(
    ...
    top_director_reserve_limit=140,
    top_director_reserve_roi=-0.32,
    coord_start_turn=18,
...
def _choose_4p_mode(obs_tensors: dict) -> str:
    # Structural experiment: replace the learned mode selector with a single
    # portfolio director. This tests whether consistent safe-growth slots plus
    # anti-brawl scoring beat the seed-shaped selector.
    return "top_director"
