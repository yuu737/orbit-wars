...
def _choose_4p_mode(obs_tensors: dict) -> str:
    ...
    # Generalized outer-lane catch-all:
    # pick lane_anchor when the board has a real outer anchor, enough nearby
    # support, and enough time to form the lane before contact.
    if (
        outer_anchor >= 55.0
