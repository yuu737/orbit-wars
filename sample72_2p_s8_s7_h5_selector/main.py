...
def _agent_h5() -> ModuleType:
    global _MOD_H5
    if _MOD_H5 is None:
        # hairate5 works best when it shares the same orbit_lite package layout
        # as the original bots/ submission path. Avoid clearing an already-loaded
        # package here; this keeps wrapper behavior aligned with direct hairate5.
        _MOD_H5 = _load_agent_module("hairate5", "_sample72_h5", clear_orbit_lite=False)
    return _MOD_H5
